...
constexpr std::string_view redfishLogDir = "/SD2:/var/log";

constexpr const char* redfishEventLogFile = "/SD2:/var/log/redfish";

constexpr const char* hostLoggerFolderPath = "/SD2:/var/log/console";
